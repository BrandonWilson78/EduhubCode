  ...
  TextView btnSkip;
    ...
    protected void onCreate(Bundle savedInstanceState) {
     ...
     //   dotsLayout = (LinearLayout) findViewById(R.id.layoutDots);
        ...
        layouts = new int[]{
                R.layout.welcomelayout_one,
                R.layout.welcomelayout_two,
                R.layout.welcomelayout_three,
                };
    ...
    //    addBottomDots(0);
        ...
        btnSkip.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(WelcomeActivity.this, StartedScreen.class));
                finish();            }
        });
